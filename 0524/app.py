...
# ==========================================
# 💡 Webhook 與 API 設定區 (請在此貼上你的專屬網址與金鑰)
# ==========================================
DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1507003066337984582/PfJvePwUqDkD4iAGX3fQnMQF-PgKORr7uxIH0xajk3cL0GAjIgqxQAS1A4cMeKtj5Cbo"
...
def send_discord_report(report_type="daily", is_manual=False):
    ...
    if not DISCORD_WEBHOOK_URL.startswith("http"):
        print("❌ [錯誤] Discord 發送失敗：尚未設定 DISCORD_WEBHOOK_URL 網址！")
        return False
